...
ALLOWED_HOSTS = ["*"]
CORS_ALLOWED_ORIGINS = ["http://localhost:3000", "https://6t62hv0h-3000.euw.devtunnels.ms"]
CSRF_TRUSTED_ORIGINS = ["http://localhost:3000, https://6t62hv0h-3000.euw.devtunnels.ms"]
