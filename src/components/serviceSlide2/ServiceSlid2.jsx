...
const ServiceSliderSecond = ({ idActive,
    setIdActive,
    apiGet,
    id,
    dignities = [],
    ...
    useEffect(() => {
        const servicesLayoutSliderInit1Element = document.querySelector(
            ".js-services-layout-slider-init-2"
        );
                                    ...
                                    >
                                        <button
                                            ...
                                            className={paggination - 1 ===
                                                sliderRef1.current.activeIndex ? "serviceBullet js-services-slider-btn-nav-2 services-layout__main-nav-btn is-active" : "serviceBullet js-services-slider-btn-nav-2 services-layout__main-nav-btn"}>
                                            {service.name}
                                        </button>
                                    </li>
                                );
            ...
            <div className="row__col--6 services-layout__main-col services-layout__main-col--slider">
                <div className="services-layout__main-slider-wrapper">
                    ...
                    <div className="slider-control services-layout__main-slider-control">
                        <button type="button" className=" js-services-slider-btn-prev-2 swiper-button swiper-button--theme-gray swiper-button-prev swiper-button-disabled'" onClick={() => handlePrevClick1(sliderRef1)}>
                        ...
                        <button type="button" className=" js-services-slider-btn-next-2 swiper-button swiper-button--theme-gray swiper-button-next" onClick={() => handleNextClick1(sliderRef1)}>
                            <svg className="u-icon">
                                <Arrow2 />
                            </svg>
                        </button>
